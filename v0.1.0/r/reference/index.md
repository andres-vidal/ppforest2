...
- [`NCI60`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/NCI60.md)
  : NCI60 Dataset

- [`bag_samples()`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/bag_samples.md)
  : In-bag row indices per tree.

- [`binarize_disabled()`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/binarize_disabled.md)
  : Disabled binarization strategy (placeholder).

- [`binarize_largest_gap()`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/binarize_largest_gap.md)
  : Largest-gap binarization strategy.

- [`california_housing`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/california_housing.md)
  : California Housing Dataset

- [`crab`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/crab.md)
  : Australian Crabs Dataset

- [`crabs`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/crabs.md)
  : Crabs Dataset
...
- [`fishcatch`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/fishcatch.md)
  : Fish Catch Dataset

- [`fitted(`*`<ppmodel>`*`)`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/fitted.ppmodel.md)
  : Fitted (in-sample) predictions from a ppforest2 model.

- [`formula(`*`<ppmodel>`*`)`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/formula.ppmodel.md)
  : Formula extractor for ppforest2 models.

- [`glass`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/glass.md)
  : Glass Dataset

- [`grouping_by_cutpoint()`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/grouping_by_cutpoint.md)
  : Cutpoint-based grouping strategy (regression).

- [`grouping_by_label()`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/grouping_by_label.md)
  : Label-based grouping strategy.

- [`image`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/image.md)
  : Image Dataset

- [`leaf_majority_vote()`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/leaf_majority_vote.md)
  : Majority-vote leaf strategy.

- [`leaf_mean_response()`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/leaf_mean_response.md)
...
- [`nobs(`*`<ppmodel>`*`)`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/nobs.ppmodel.md)
...
- [`oob_predictions()`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/oob_predictions.md)
...
- [`parkinson`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/parkinson.md)
  : Parkinson Dataset
...
- [`plot(`*`<pprf>`*`)`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/plot.pprf.md)
  : Plot a pprf model.

- [`plot(`*`<pptr>`*`)`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/plot.pptr.md)
  : Plot a pptr model.
...
- [`predict(`*`<pprf_classification>`*`)`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/predict.pprf_classification.md)
...
- [`predict(`*`<pptr_classification>`*`)`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/predict.pptr_classification.md)
  : Predicts labels or per-group one-hot proportions from a pptr model
  (classification mode).

- [`predict(`*`<pptr_regression>`*`)`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/predict.pptr_regression.md)
...
- [`projection_importance()`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/projection_importance.md)
  : Projection-coefficient variable importance.

- [`residuals(`*`<ppmodel>`*`)`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/residuals.ppmodel.md)
...
- [`stop_max_depth()`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/stop_max_depth.md)
  : Maximum-depth stopping rule.

- [`stop_min_size()`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/stop_min_size.md)
...
- [`stop_pure_node()`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/stop_pure_node.md)
...
- [`update(`*`<pp_rand_forest>`*`)`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/update.pp_rand_forest.md)
  :

  Update a `pp_rand_forest` model specification.

- [`update(`*`<pp_tree>`*`)`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/update.pp_tree.md)
  :
...
- [`weighted_importance()`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/weighted_importance.md)
  : Weighted projection variable importance for a random forest.

- [`wine`](https://andres-vidal.github.io/ppforest2/v0.1.0/r/reference/wine.md)
  : Wine Dataset
