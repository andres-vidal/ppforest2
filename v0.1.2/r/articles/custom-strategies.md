...
|--------------------------------|----------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **PP** (projection pursuit)    | Find the projection that best separates groups     | [`pp_pda()`](https://andres-vidal.github.io/ppforest2/v0.1.2/r/reference/pp_pda.md) — Penalized Discriminant Analysis                                                                    |
| **Vars** (variable selection)  | Select which variables are available at each split | [`vars_uniform()`](https://andres-vidal.github.io/ppforest2/v0.1.2/r/reference/vars_uniform.md), [`vars_all()`](https://andres-vidal.github.io/ppforest2/v0.1.2/r/reference/vars_all.md) |
| **Threshold** (split cutpoint) | Compute the split cutpoint in projected space      | [`cutpoint_mean_of_means()`](https://andres-vidal.github.io/ppforest2/v0.1.2/r/reference/cutpoint_mean_of_means.md)                                                                      |
| **Stop** (stopping rule)       | Decide when to stop growing                        | [`stop_pure_node()`](https://andres-vidal.github.io/ppforest2/v0.1.2/r/reference/stop_pure_node.md)                                                                                      |
| **Binarize** (binarization)    | Reduce multiclass to binary at each node           | [`binarize_largest_gap()`](https://andres-vidal.github.io/ppforest2/v0.1.2/r/reference/binarize_largest_gap.md)                                                                          |
| **Grouping** (group partition) | Route observations to children                     | [`grouping_by_label()`](https://andres-vidal.github.io/ppforest2/v0.1.2/r/reference/grouping_by_label.md)                                                                                |
